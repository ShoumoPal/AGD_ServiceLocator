...
namespace ServiceLocator.Wave
{
    public class WaveService
    {
        ...
        public WaveService(WaveScriptableObject waveScriptableObject, EventService eventService)
        {
        ...
        {
            bloonPool = new BloonPool(GameService.Instance.playerService, this, GameService.Instance.soundService, waveScriptableObject);
